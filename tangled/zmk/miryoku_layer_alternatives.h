...
U_LT(U_BUTTON, W), U_LT(U_FUN, X),    U_MT(RALT, C),     U_LT(U_SYM, V),    &kp B,             &kp N,             U_LT(U_NAV, COMMA),&kp DOT,           U_LT(U_MEDIA, SLASH),U_LT(U_BUTTON, SQT),\
U_NP,              U_NP,              &kp LA(TAB),       &td_skq U_NUM,     &td_skq LSHFT,     U_LT(U_MOUSE, SPACE),U_LT(U_NAV, SPACE),&key_repeat,       U_NP,              U_NP
...
U_LT(U_BUTTON, J), U_LT(U_FUN, SLASH),U_MT(RALT, COMMA), U_LT(U_SYM, K),    &kp SQT,           &kp W,             U_LT(U_NAV, M),    &kp L,             U_LT(U_MEDIA, P),  U_LT(U_BUTTON, V), \
U_NP,              U_NP,              &kp LA(TAB),       &td_skq U_NUM,     &td_skq LSHFT,     U_LT(U_MOUSE, SPACE),U_LT(U_NAV, SPACE),&key_repeat,       U_NP,              U_NP
...
U_LT(U_BUTTON, Z), U_LT(U_FUN, X),    U_MT(RALT, C),     U_LT(U_SYM, V),    &kp B,             &kp K,             U_LT(U_NAV, H),    &kp BSPC,          U_LT(U_MEDIA, DOT),U_LT(U_BUTTON, COMMA),\
U_NP,              U_NP,              &kp LA(TAB),       &td_skq U_NUM,     &td_skq LSHFT,     U_LT(U_MOUSE, SPACE),U_LT(U_NAV, SPACE),&key_repeat,       U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH_FLIP \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LGUI, A),     U_MT(LALT, R),     U_MT(LCTRL, S),    U_MT(LSHFT, T),    &kp G,             &kp M,             U_MT(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
U_LT(U_BUTTON, Z), U_LT(U_FUN, X),    U_MT(RALT, C),     U_LT(U_SYM, D),    &kp V,             &kp K,             U_LT(U_NAV, H),    &kp BSPC,          U_LT(U_MEDIA, DOT),U_LT(U_BUTTON, COMMA),\
U_NP,              U_NP,              &kp LA(TAB),       &td_skq U_NUM,     &td_skq LSHFT,     U_LT(U_MOUSE, SPACE),U_LT(U_NAV, SPACE),&key_repeat,       U_NP,              U_NP
...
U_LT(U_BUTTON, Z), U_LT(U_FUN, X),    U_MT(RALT, C),     U_LT(U_SYM, D),    &kp V,             &kp M,             U_LT(U_NAV, H),    &kp COMMA,         U_LT(U_MEDIA, DOT),U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              &kp LA(TAB),       &td_skq U_NUM,     &td_skq LSHFT,     U_LT(U_MOUSE, SPACE),U_LT(U_NAV, SPACE),&key_repeat,       U_NP,              U_NP
...
U_LT(U_BUTTON, SLASH),U_LT(U_FUN, Q),    U_MT(RALT, J),     U_LT(U_SYM, K),    &kp X,             &kp B,             U_LT(U_NAV, M),    &kp W,             U_LT(U_MEDIA, V),  U_LT(U_BUTTON, Z), \
U_NP,              U_NP,              &kp LA(TAB),       &td_skq U_NUM,     &td_skq LSHFT,     U_LT(U_MOUSE, SPACE),U_LT(U_NAV, SPACE),&key_repeat,       U_NP,              U_NP
...
U_LT(U_BUTTON, F), U_LT(U_FUN, M),    U_MT(RALT, V),     U_LT(U_SYM, C),    &kp SLASH,         &kp G,             U_LT(U_NAV, P),    &kp X,             U_LT(U_MEDIA, K),  U_LT(U_BUTTON, Y), \
U_NP,              U_NP,              &kp LA(TAB),       &td_skq U_NUM,     &td_skq LSHFT,     U_LT(U_MOUSE, SPACE),U_LT(U_NAV, SPACE),&key_repeat,       U_NP,              U_NP
...
U_LT(U_BUTTON, Z), U_LT(U_FUN, X),    U_MT(RALT, M),     U_LT(U_SYM, C),    &kp V,             &kp K,             U_LT(U_NAV, L),    &kp COMMA,         U_LT(U_MEDIA, DOT),U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              &kp LA(TAB),       &td_skq U_NUM,     &td_skq LSHFT,     U_LT(U_MOUSE, SPACE),U_LT(U_NAV, SPACE),&key_repeat,       U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY_FLIP \
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, D),    U_MT(LSHFT, F),    &kp G,             &kp H,             U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SQT),   \
U_LT(U_BUTTON, Z), U_LT(U_FUN, X),    U_MT(RALT, C),     U_LT(U_SYM, V),    &kp B,             &kp N,             U_LT(U_NAV, M),    &kp COMMA,         U_LT(U_MEDIA, DOT),U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              &kp LA(TAB),       &td_skq U_NUM,     &td_skq LSHFT,     U_LT(U_MOUSE, SPACE),U_LT(U_NAV, SPACE),&key_repeat,       U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ_FLIP \
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Z,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, D),    U_MT(LSHFT, F),    &kp G,             &kp H,             U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SQT),   \
U_LT(U_BUTTON, Y), U_LT(U_FUN, X),    U_MT(RALT, C),     U_LT(U_SYM, V),    &kp B,             &kp N,             U_LT(U_NAV, M),    &kp COMMA,         U_LT(U_MEDIA, DOT),U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              &kp LA(TAB),       &td_skq U_NUM,     &td_skq LSHFT,     U_LT(U_MOUSE, SPACE),U_LT(U_NAV, SPACE),&key_repeat,       U_NP,              U_NP
...
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LGUI, A),     U_MT(LALT, R),     U_MT(LCTRL, S),    U_MT(LSHFT, T),    &kp G,             &kp M,             U_MT(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp BSPC,          U_MT(RALT, DOT),   U_LT(U_BUTTON, COMMA),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, SPACE),U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, BSPC), U_LT(U_FUN, DEL),  U_NP,              U_NP
...
U_NP,              U_NP,              &kp LA(TAB),       &td_skq U_NUM,     &td_skq LSHFT,     &kp SPACE,         &kp SPACE,         &key_repeat,       U_NP,              U_NP
...
&kp Z,             &kp X,             &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp BSPC,          &kp DOT,           &kp COMMA,         \
U_NP,              U_NP,              &kp LA(TAB),       &td_skq U_NUM,     &td_skq LSHFT,     &kp SPACE,         &kp SPACE,         &key_repeat,       U_NP,              U_NP
...
&kp BSPC,          U_CUT,             U_CPY,             U_PST,             &kp DEL,           &u_to_U_NAV,       U_NA,              &u_to_U_NUM,       U_NA,              U_NA,              \
U_NP,              U_NP,              &kp ESC,           &kp K_APP,         &kp RET,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             &u_to_U_NAV,       U_NA,              &u_to_U_NUM,       U_NA,              U_NA,              \
...
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             &u_to_U_MOUSE,     U_NA,              &u_to_U_SYM,       U_NA,              U_NA,              \
...
&u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       &u_out_tog,        &u_to_U_MEDIA,     U_NA,              &u_to_U_FUN,       U_NA,              U_NA,              \
...
&kp LC(LG(LEFT)),  &kp LC(LG(RIGHT)), &kp TAB,           &kp DEL,           &kp ESC,           &kp LBKT,          &kp N7,            &kp N8,            &kp N9,            &kp RBKT,          \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &mt LSHIFT SLASH,  &kp QMARK,         &kp EQUAL,         &kp N4,            &kp N5,            &kp N6,            &kp MINUS,         \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             &kp BSLH,          &kp N1,            &kp N2,            &kp N3,            &kp GRAVE,         \
U_NP,              U_NP,              &u_to_U_BASE,      U_NA,              &kp ASTRK,         &kp UNDER,         &kp N0,            &kp DOT,           U_NP,              U_NP
...
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              &kp PLUS,          &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp UNDER,         \
...
U_NA,              U_NA,              &kp RALT,          U_NA,              U_NA,              &kp PAUSE_BREAK,   &kp F1,            &kp F2,            &kp F3,            &kp F10,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp TAB,           &kp SPACE,         &kp ESC,           U_NP,              U_NP
