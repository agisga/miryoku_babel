...
LT(U_BUTTON,KC_W), LT(U_FUN,KC_X),    KC_C,              KC_V,              KC_B,              KC_N,              KC_COMM,           KC_DOT,            LT(U_MEDIA,KC_SLSH),LT(U_BUTTON,KC_QUOT),\
...
LT(U_BUTTON,KC_J), LT(U_FUN,KC_SLSH), KC_COMM,           KC_K,              KC_QUOT,           KC_W,              KC_M,              KC_L,              LT(U_MEDIA,KC_P),  LT(U_BUTTON,KC_V), \
U_NP,              U_NP,              KC_AT_SPECIAL,     TD(OSL_U_NUM_ESC), TD(OSM_LSFT_ENT),  LT(U_MOUSE,KC_SPC),LT(U_NAV,KC_SPC),  KC_REPEAT,         U_NP,              U_NP
...
LT(U_BUTTON,KC_Z), LT(U_FUN,KC_X),    KC_C,              KC_D,              KC_V,              KC_K,              KC_H,              KC_COMM,           LT(U_MEDIA,KC_DOT),LT(U_BUTTON,KC_SLSH),\
U_NP,              U_NP,              KC_AT_SPECIAL,     TD(OSL_U_NUM_ESC), TD(OSM_LSFT_ENT),  LT(U_MOUSE,KC_SPC),LT(U_NAV,KC_SPC),  KC_REPEAT,         U_NP,              U_NP
...
LT(U_BUTTON,KC_Z), LT(U_FUN,KC_X),    KC_C,              KC_D,              KC_V,              KC_M,              KC_H,              KC_COMM,           LT(U_MEDIA,KC_DOT),LT(U_BUTTON,KC_SLSH),\
U_NP,              U_NP,              KC_AT_SPECIAL,     TD(OSL_U_NUM_ESC), TD(OSM_LSFT_ENT),  LT(U_MOUSE,KC_SPC),LT(U_NAV,KC_SPC),  KC_REPEAT,         U_NP,              U_NP
...
LT(U_BUTTON,KC_SLSH),LT(U_FUN,KC_Q),    KC_J,              KC_K,              KC_X,              KC_B,              KC_M,              KC_W,              LT(U_MEDIA,KC_V),  LT(U_BUTTON,KC_Z), \
U_NP,              U_NP,              KC_AT_SPECIAL,     TD(OSL_U_NUM_ESC), TD(OSM_LSFT_ENT),  LT(U_MOUSE,KC_SPC),LT(U_NAV,KC_SPC),  KC_REPEAT,         U_NP,              U_NP
...
LT(U_BUTTON,KC_F), LT(U_FUN,KC_M),    KC_V,              KC_C,              KC_SLSH,           KC_G,              KC_P,              KC_X,              LT(U_MEDIA,KC_K),  LT(U_BUTTON,KC_Y), \
U_NP,              U_NP,              KC_AT_SPECIAL,     TD(OSL_U_NUM_ESC), TD(OSM_LSFT_ENT),  LT(U_MOUSE,KC_SPC),LT(U_NAV,KC_SPC),  KC_REPEAT,         U_NP,              U_NP
...
LT(U_BUTTON,KC_Z), LT(U_FUN,KC_X),    KC_M,              KC_C,              KC_V,              KC_K,              KC_L,              KC_COMM,           LT(U_MEDIA,KC_DOT),LT(U_BUTTON,KC_SLSH),\
U_NP,              U_NP,              KC_AT_SPECIAL,     TD(OSL_U_NUM_ESC), TD(OSM_LSFT_ENT),  LT(U_MOUSE,KC_SPC),LT(U_NAV,KC_SPC),  KC_REPEAT,         U_NP,              U_NP
...
LT(U_BUTTON,KC_Z), LT(U_FUN,KC_X),    KC_C,              KC_V,              KC_B,              KC_N,              KC_M,              KC_COMM,           LT(U_MEDIA,KC_DOT),LT(U_BUTTON,KC_SLSH),\
U_NP,              U_NP,              KC_AT_SPECIAL,     TD(OSL_U_NUM_ESC), TD(OSM_LSFT_ENT),  LT(U_MOUSE,KC_SPC),LT(U_NAV,KC_SPC),  KC_REPEAT,         U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ_FLIP \
KC_Q,              KC_W,              LT(U_SYM,KC_E),    KC_R,              KC_T,              KC_Z,              KC_U,              KC_I,              KC_O,              KC_P,              \
LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_QUOT),   \
LT(U_BUTTON,KC_Y), LT(U_FUN,KC_X),    KC_C,              KC_V,              KC_B,              KC_N,              KC_M,              KC_COMM,           LT(U_MEDIA,KC_DOT),LT(U_BUTTON,KC_SLSH),\
U_NP,              U_NP,              KC_AT_SPECIAL,     TD(OSL_U_NUM_ESC), TD(OSM_LSFT_ENT),  LT(U_MOUSE,KC_SPC),LT(U_NAV,KC_SPC),  KC_REPEAT,         U_NP,              U_NP
...
LGUI_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LSFT_T(KC_T),      KC_D,              KC_H,              LSFT_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_I),      LGUI_T(KC_O),      \
LT(U_BUTTON,KC_Z), ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,              KC_K,              KC_M,              KC_BSPC,           ALGR_T(KC_DOT),    LT(U_BUTTON,KC_COMM),\
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_SPC),  LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP
...
U_NP,              U_NP,              KC_AT_SPECIAL,     TD(OSL_U_NUM_ESC), TD(OSM_LSFT_ENT),  KC_SPC,            KC_SPC,            KC_REPEAT,         U_NP,              U_NP
...
KC_Z,              KC_X,              KC_C,              KC_V,              KC_B,              KC_K,              KC_M,              KC_BSPC,           KC_DOT,            KC_COMM,           \
U_NP,              U_NP,              KC_AT_SPECIAL,     TD(OSL_U_NUM_ESC), TD(OSM_LSFT_ENT),  KC_SPC,            KC_SPC,            KC_REPEAT,         U_NP,              U_NP
...
U_NA,              U_NA,              C(G(KC_LEFT)),     C(G(KC_RIGHT)),    U_NA,              KC_PIPE,           KC_DLR,            KC_PERC,           KC_CIRC,           KC_TILD,           \
...
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    U_NA,              TD(U_TD_U_BASE),   U_NA,              KC_PSCR,           KC_F7,             KC_F8,             KC_F9,             KC_F12,            \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              KC_SCRL,           KC_F1,             KC_F2,             KC_F3,             KC_F10,            \
U_NA,              U_NA,              C(G(KC_LEFT)),     C(G(KC_RIGHT)),    U_NA,              KC_PAUS,           KC_F4,             KC_F5,             KC_F6,             KC_F11,            \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_TAB,            KC_SPC,            KC_ESC,            U_NP,              U_NP
...
KC_COLONQ,         KC_COLONWQ,        KC_COLONQEX,       U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              KC_LPRN,           KC_RPRN,           \
