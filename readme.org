...
#+NAME: button
| Q      | QU     | QUE    |        |        | U_RDO | U_PST | U_CPY | U_CUT | U_UND |
...
#+NAME: thumbs-flip
| U_NP | U_NP | DEL | ' | OSM_LSFT | SPC | SPC | ESC | U_NP | U_NP |
...
| U_NP     | U_NP      | U_FUN    | U_NUM      | U_NA | U_MOUSE | U_NAV      | U_MEDIA     | U_NP      | U_NP     |
