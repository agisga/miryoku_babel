...
U_LT("W", U_BUTTON),U_LT("X", U_FUN),  U_MT("C", "AltGr"),U_LT("V", U_SYM),  "B",               "N",               U_SLT("<", "S_COMM", U_NAV),U_S(">", "."),     U_SLT("?", "/", U_MEDIA),U_SLT("\"", "'", U_BUTTON),\
U_NP,              U_NP,              U_NU,              U_NU,              U_NU,              U_LT("Space", U_MOUSE),U_LT("Space", U_NAV),U_NU,              U_NP,              U_NP
...
U_LT("J", U_BUTTON),U_SLT("?", "/", U_FUN),U_SMT("<", "S_COMM", "AltGr"),U_LT("K", U_SYM),  U_S("\"", "'"),    "W",               U_LT("M", U_NAV),  "L",               U_LT("P", U_MEDIA),U_LT("V", U_BUTTON),\
U_NP,              U_NP,              U_NU,              U_NU,              U_NU,              U_LT("Space", U_MOUSE),U_LT("Space", U_NAV),U_NU,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAK_FLIP \
"Q",               "W",               "F",               "P",               "G",               "J",               "L",               "U",               "Y",               U_S("\"", "'"),    \
U_MT("A", "Meta"), U_MT("R", "Alt"),  U_MT("S", "Ctrl"), U_MT("T", "Shift"),"D",               "M",               U_MT("N", "Shift"),U_MT("E", "Ctrl"), U_MT("I", "Alt"),  U_MT("O", "Meta"), \
U_LT("Z", U_BUTTON),U_LT("X", U_FUN),  U_MT("C", "AltGr"),U_LT("V", U_SYM),  "B",               "K",               U_LT("H", U_NAV),  "Back Space",      U_SLT(">", ".", U_MEDIA),U_SLT("<", "S_COMM", U_BUTTON),\
U_NP,              U_NP,              U_NU,              U_NU,              U_NU,              U_LT("Space", U_MOUSE),U_LT("Space", U_NAV),U_NU,              U_NP,              U_NP
...
U_LT("Z", U_BUTTON),U_LT("X", U_FUN),  U_MT("C", "AltGr"),U_LT("D", U_SYM),  "V",               "K",               U_LT("H", U_NAV),  "Back Space",      U_SLT(">", ".", U_MEDIA),U_SLT("<", "S_COMM", U_BUTTON),\
U_NP,              U_NP,              U_NU,              U_NU,              U_NU,              U_LT("Space", U_MOUSE),U_LT("Space", U_NAV),U_NU,              U_NP,              U_NP
...
U_LT("Z", U_BUTTON),U_LT("X", U_FUN),  U_MT("C", "AltGr"),U_LT("D", U_SYM),  "V",               "M",               U_LT("H", U_NAV),  U_S("<", "S_COMM"),U_SLT(">", ".", U_MEDIA),U_SLT("?", "/", U_BUTTON),\
U_NP,              U_NP,              U_NU,              U_NU,              U_NU,              U_LT("Space", U_MOUSE),U_LT("Space", U_NAV),U_NU,              U_NP,              U_NP
...
U_SLT("?", "/", U_BUTTON),U_LT("Q", U_FUN),  U_MT("J", "AltGr"),U_LT("K", U_SYM),  "X",               "B",               U_LT("M", U_NAV),  "W",               U_LT("V", U_MEDIA),U_LT("Z", U_BUTTON),\
U_NP,              U_NP,              U_NU,              U_NU,              U_NU,              U_LT("Space", U_MOUSE),U_LT("Space", U_NAV),U_NU,              U_NP,              U_NP
...
U_LT("F", U_BUTTON),U_LT("M", U_FUN),  U_MT("V", "AltGr"),U_LT("C", U_SYM),  U_S("?", "/"),     "G",               U_LT("P", U_NAV),  "X",               U_LT("K", U_MEDIA),U_LT("Y", U_BUTTON),\
U_NP,              U_NP,              U_NU,              U_NU,              U_NU,              U_LT("Space", U_MOUSE),U_LT("Space", U_NAV),U_NU,              U_NP,              U_NP
...
U_LT("Z", U_BUTTON),U_LT("X", U_FUN),  U_MT("M", "AltGr"),U_LT("C", U_SYM),  "V",               "K",               U_LT("L", U_NAV),  U_S("<", "S_COMM"),U_SLT(">", ".", U_MEDIA),U_SLT("?", "/", U_BUTTON),\
U_NP,              U_NP,              U_NU,              U_NU,              U_NU,              U_LT("Space", U_MOUSE),U_LT("Space", U_NAV),U_NU,              U_NP,              U_NP
...
U_LT("Z", U_BUTTON),U_LT("X", U_FUN),  U_MT("C", "AltGr"),U_LT("V", U_SYM),  "B",               "N",               U_LT("M", U_NAV),  U_S("<", "S_COMM"),U_SLT(">", ".", U_MEDIA),U_SLT("?", "/", U_BUTTON),\
U_NP,              U_NP,              U_NU,              U_NU,              U_NU,              U_LT("Space", U_MOUSE),U_LT("Space", U_NAV),U_NU,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ_FLIP \
"Q",               "W",               "E",               "R",               "T",               "Z",               "U",               "I",               "O",               "P",               \
U_MT("A", "Meta"), U_MT("S", "Alt"),  U_MT("D", "Ctrl"), U_MT("F", "Shift"),"G",               "H",               U_MT("J", "Shift"),U_MT("K", "Ctrl"), U_MT("L", "Alt"),  U_SMT("\"", "'", "Meta"),\
U_LT("Y", U_BUTTON),U_LT("X", U_FUN),  U_MT("C", "AltGr"),U_LT("V", U_SYM),  "B",               "N",               U_LT("M", U_NAV),  U_S("<", "S_COMM"),U_SLT(">", ".", U_MEDIA),U_SLT("?", "/", U_BUTTON),\
U_NP,              U_NP,              U_NU,              U_NU,              U_NU,              U_LT("Space", U_MOUSE),U_LT("Space", U_NAV),U_NU,              U_NP,              U_NP
...
"Q",               "W",               "F",               "P",               "G",               "J",               "L",               "U",               "Y",               U_S("\"", "'"),    \
U_MT("A", "Meta"), U_MT("R", "Alt"),  U_MT("S", "Ctrl"), U_MT("T", "Shift"),"D",               "M",               U_MT("N", "Shift"),U_MT("E", "Ctrl"), U_MT("I", "Alt"),  U_MT("O", "Meta"), \
U_LT("Z", U_BUTTON),U_MT("X", "AltGr"),"C",               "V",               "B",               "K",               "H",               "Back Space",      U_SMT(">", ".", "AltGr"),U_SLT("<", "S_COMM", U_BUTTON),\
U_NP,              U_NP,              U_LT("Esc", U_MEDIA),U_LT("Space", U_NAV),U_LT("Tab", U_MOUSE),U_LT("Enter", U_SYM),U_LT("Back Space", U_NUM),U_LT("Delete", U_FUN),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH \
"Q",               "W",               "F",               "P",               "B",               "J",               "L",               "U",               "Y",               U_S("\"", "'"),    \
U_MT("A", "Meta"), U_MT("R", "Alt"),  U_MT("S", "Ctrl"), U_MT("T", "Shift"),"G",               "M",               U_MT("N", "Shift"),U_MT("E", "Ctrl"), U_MT("I", "Alt"),  U_MT("O", "Meta"), \
U_LT("Z", U_BUTTON),U_MT("X", "AltGr"),"C",               "D",               "V",               "K",               "H",               "Back Space",      U_SMT(">", ".", "AltGr"),U_SLT("<", "S_COMM", U_BUTTON),\
U_NP,              U_NP,              U_LT("Esc", U_MEDIA),U_LT("Space", U_NAV),U_LT("Tab", U_MOUSE),U_LT("Enter", U_SYM),U_LT("Back Space", U_NUM),U_LT("Delete", U_FUN),U_NP,              U_NP
...
"Q",               "S",               "D",               "F",               "G",               "H",               "J",               "K",               "L",               "M",               \
"W",               "X",               "C",               "V",               "B",               "N",               "S_COMM",          ".",               "/",               "'",               \
U_NP,              U_NP,              U_NU,              U_NU,              U_NU,              "Space",           "Space",           U_NU,              U_NP,              U_NP
...
"Q",               "W",               "F",               "P",               "G",               "J",               "L",               "U",               "Y",               "'",               \
"A",               "R",               "S",               "T",               "D",               "M",               "N",               "E",               "I",               "O",               \
"Z",               "X",               "C",               "V",               "B",               "K",               "H",               "Back Space",      ".",               "S_COMM",          \
U_NP,              U_NP,              U_NU,              U_NU,              U_NU,              "Space",           "Space",           U_NU,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_TAP_COLEMAKDH_FLIP \
"Q",               "W",               "F",               "P",               "B",               "J",               "L",               "U",               "Y",               "'",               \
"A",               "R",               "S",               "T",               "G",               "M",               "N",               "E",               "I",               "O",               \
"Z",               "X",               "C",               "D",               "V",               "K",               "H",               "Back Space",      ".",               "S_COMM",          \
U_NP,              U_NP,              U_NU,              U_NU,              U_NU,              "Space",           "Space",           U_NU,              U_NP,              U_NP
...
"Back Space",      U_CUT,             U_CPY,             U_PST,             "Delete",          U_DF(U_NAV),       U_HELD(U_NA),      U_DF(U_NUM),       U_NA,              U_NA,              \
U_NP,              U_NP,              "Esc",             "App",             "Enter",           U_NA,              U_HELD(U_NA),      U_NA,              U_NP,              U_NP
...
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_DF(U_NAV),       U_HELD(U_NA),      U_DF(U_NUM),       U_NA,              U_NA,              \
...
U_S("Clear", "BT  0 Select"),U_S("Clear", "BT  1 Select"),U_S("Clear", "BT  2 Select"),U_S("Clear", "BT  3 Select"),U_S("USB", "Out Toggle"),U_DF(U_MEDIA),     U_NA,              U_DF(U_FUN),       U_HELD(U_NA),      U_NA,              \
U_NP,              U_NP,              "Mute",            "Play Pause",      "Stop",            U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
"Meta",            "Alt",             "Ctrl",            "Shift",           U_NA,              U_S("+", "="),     U_S("$", "4"),     U_S("%", "5"),     U_S("^", "6"),     U_S("_", "-"),     \
U_NA,              U_NA,              "AltGr",           U_NA,              U_NA,              U_S("S_PIPE", "\\"),U_S("!", "1"),     U_S("@", "2"),     U_S("#", "3"),     U_S("~", "`"),     \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              "_",               U_S("S_RPRN", "0"),U_S(">", "."),     U_NP,              U_NP
...
"Meta",            "Alt",             "Ctrl",            "Shift",           U_NA,              "+",               "$",               "%",               "^",               "_",               \
U_NA,              U_NA,              "AltGr",           U_HELD(U_NA),      U_NA,              "S_PIPE",          "!",               "@",               "#",               "~",               \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              U_S("_", "-"),     "S_RPRN",          U_NP,              U_NP,              U_NP
...
U_NA,              U_HELD(U_NA),      "AltGr",           U_NA,              U_NA,              "Pause Break",     "F1",              "F2",              "F3",              "F10",             \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              "Tab",             "Space",           "Esc",             U_NP,              U_NP
...
"COLONQ",          "COLONW",          "COLONWQ",         "COLONQEX",        ":",               U_NU,              U_NU,              U_NU,              "S_LPRN",          "S_RPRN",          \
U_NU,              "AUTOCLOS_CURLYBRA",U_NU,              "AUTOCLOS_SQBRA",  "AUTOCLOS_ANGLEBRA","TODO",            "AUTOCLOS_QUOTE",  "AUTOCLOS_PAREN",  "FIFTEENSTARS",    U_NU,              \
U_HELD(U_NU),      U_NU,              "Volume Down",     "Volume Up",       "Mute",            "<",               "LEFTARR",         "ELLIPSIS",        "RIGHTARR",        U_HELD(">"),       \
