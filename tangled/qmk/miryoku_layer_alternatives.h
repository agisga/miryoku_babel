...
QK_BOOT,           DF(U_TAP),         U_NA,              DF(U_BASE),        KC_SCLN,           KC_LBRC,           KC_7,              KC_8,              KC_9,              KC_RBRC,           \
...
QK_BOOT,           DF(U_TAP),         U_NA,              DF(U_BASE),        KC_SCLN,           KC_LCBR,           KC_AMPR,           KC_ASTR,           KC_LPRN,           KC_RCBR,           \
...
QK_BOOT,           DF(U_TAP),         U_NA,              DF(U_BASE),        KC_SCLN,           DYN_REC_START1,    KC_F7,             KC_F8,             KC_F9,             KC_F12,            \
