...
U_MT(RALT, W),     &kp X,             &kp C,             U_LT(U_SYM, V),    &kp B,             &kp N,             &kp COMMA,         &kp DOT,           &kp SLASH,         U_LT(U_BUTTON, SQT),\
...
U_MT(RALT, J),     &kp SLASH,         &kp COMMA,         U_LT(U_SYM, K),    &kp SQT,           &kp W,             &kp M,             &kp L,             &kp P,             U_LT(U_BUTTON, V), \
U_NP,              U_NP,              U_LT(U_FUN, DEL),  &sl U_NUM,         &skq LSHFT,        U_LT(U_MOUSE, SPC),U_LT(U_NAV, SPC),  U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
U_MT(RALT, Z),     &kp X,             &kp C,             U_LT(U_SYM, V),    &kp B,             &kp K,             &kp M,             &kp COMMA,         &kp DOT,           U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  &sl U_NUM,         &skq LSHFT,        U_LT(U_MOUSE, SPC),U_LT(U_NAV, SPC),  U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
U_MT(RALT, Z),     &kp X,             &kp C,             U_LT(U_SYM, D),    &kp V,             &kp K,             &kp H,             &kp COMMA,         &kp DOT,           U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  &sl U_NUM,         &skq LSHFT,        U_LT(U_MOUSE, SPC),U_LT(U_NAV, SPC),  U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
U_MT(RALT, Z),     &kp X,             &kp C,             U_LT(U_SYM, D),    &kp V,             &kp M,             &kp H,             &kp COMMA,         &kp DOT,           U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  &sl U_NUM,         &skq LSHFT,        U_LT(U_MOUSE, SPC),U_LT(U_NAV, SPC),  U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
U_MT(RALT, SLASH), &kp Q,             &kp J,             U_LT(U_SYM, K),    &kp X,             &kp B,             &kp M,             &kp W,             &kp V,             U_LT(U_BUTTON, Z), \
U_NP,              U_NP,              U_LT(U_FUN, DEL),  &sl U_NUM,         &skq LSHFT,        U_LT(U_MOUSE, SPC),U_LT(U_NAV, SPC),  U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
U_MT(RALT, F),     &kp M,             &kp V,             U_LT(U_SYM, C),    &kp SLASH,         &kp G,             &kp P,             &kp X,             &kp K,             U_LT(U_BUTTON, Y), \
U_NP,              U_NP,              U_LT(U_FUN, DEL),  &sl U_NUM,         &skq LSHFT,        U_LT(U_MOUSE, SPC),U_LT(U_NAV, SPC),  U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
U_MT(RALT, Z),     &kp X,             &kp M,             U_LT(U_SYM, C),    &kp V,             &kp K,             &kp L,             &kp COMMA,         &kp DOT,           U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  &sl U_NUM,         &skq LSHFT,        U_LT(U_MOUSE, SPC),U_LT(U_NAV, SPC),  U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
U_MT(RALT, Z),     &kp X,             &kp C,             U_LT(U_SYM, V),    &kp B,             &kp N,             &kp M,             &kp COMMA,         &kp DOT,           U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  &sl U_NUM,         &skq LSHFT,        U_LT(U_MOUSE, SPC),U_LT(U_NAV, SPC),  U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ_FLIP \
&kp Q,             &kp W,             U_LT(U_SYM, E),    &kp R,             &kp T,             &kp Z,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, D),    U_MT(LSHFT, F),    &kp G,             &kp H,             U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MT(LGUI, SQT),   \
U_MT(RALT, Y),     &kp X,             &kp C,             U_LT(U_SYM, V),    &kp B,             &kp N,             &kp M,             &kp COMMA,         &kp DOT,           U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  &sl U_NUM,         &skq LSHFT,        U_LT(U_MOUSE, SPC),U_LT(U_NAV, SPC),  U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
&kp RALT,          U_NA,              &u_to_U_MOUSE,     U_NA,              U_NA,              &kp PIPE,          &kp DLLR,          &kp PRCT,          &kp CRRT,          &kp TILDE,         \
...
&kp RALT,          U_NA,              &u_to_U_MEDIA,     U_NA,              U_NA,              U_NU,              &kp F4,            &kp F5,            &kp F6,            &kp F11,           \
