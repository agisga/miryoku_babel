...
#+NAME: button
| COLONQ | COLONW | COLONWQ | COLONQEX | :     |                   |                | FIFTEENSTARS   | (              | )                 |
| ALGR_Q | ALGR_P | ALGR_S  | ALGR_Y   | ;     | AUTOCLOS_ANGLEBRA | AUTOCLOS_QUOTE | AUTOCLOS_PAREN | AUTOCLOS_SQBRA | AUTOCLOS_CURLYBRA |
...
| BOOT     | DF(U_TAP) | DF(U_EXTRA) | DF(U_BASE) |      |         | DF(U_BASE) | DF(U_EXTRA) | DF(U_TAP) | BOOT     |
| LGUI     | LALT      | LCTL        | LSFT       |      |         | LSFT       | LCTL        | LALT      | LGUI     |
| U_BUTTON | U_FUN     | ALGR        | U_SYM      |      |         | LOCK_CUR   | LOCK_OPP    | U_MEDIA   | U_BUTTON |
...
| U_NP | U_NP | DF(U_BASE) | U_NA | * | _ | MINS | DOT | U_NP | U_NP |
...
#+NAME: nonkc
| U_ | RGB_ | OU_ | QK_ | S( | C( | SCMD( | LCMD( | TD( | CW_TOGG | DYN_ | OSL( | OSM( | RALT( | APP_SWITCHER |
