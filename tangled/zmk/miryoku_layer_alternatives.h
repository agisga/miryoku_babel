...
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, SQT),  &skq LSHFT,        U_LT(U_MOUSE, SPC),U_LT(U_NAV, SPC),  U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp K,             &kp M,             &kp COMMA,         &kp DOT,           U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, SQT),  &skq LSHFT,        U_LT(U_MOUSE, SPC),U_LT(U_NAV, SPC),  U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
U_NP,              U_NP,              &kp DEL,           &kp SQT,           &skq LSHFT,        &kp SPC,           &kp SPC,           &kp ESC,           U_NP,              U_NP
...
U_NU,              &kp RALT,          &u_to_U_NAV,       &u_to_U_NUM,       U_NU,              &kp BSLH,          &kp NUM_4,         &kp NUM_5,         &kp NUM_6,         &kp GRAVE,         \
...
U_NA,              &kp RALT,          &u_to_U_MEDIA,     &u_to_U_FUN,       U_NA,              U_NU,              &kp F4,            &kp F5,            &kp F6,            &kp F11,           \
...
&kp Q,             &kp QU,            &kp QUE,           U_NU,              U_NU,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
