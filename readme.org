...
#+NAME: button
| COLONQ | COLONWQ | QUE    | QU     |       |   |                | LATEX_PAREN    | LATEX_SQBRA    | LATEX_CURLYBRA    |
| ALGR_Q | ALGR_P  | ALGR_S | ALGR_Y |       |   | AUTOCLOS_QUOTE | AUTOCLOS_PAREN | AUTOCLOS_SQBRA | AUTOCLOS_CURLYBRA |
| U_UND  | U_CUT   | U_CPY  | U_PST  | U_RDO |   |                |                | ELLIPSIS       | PARENQ            |
...
#+NAME: thumbs-flip
| U_NP | U_NP | DEL | OSL_U_NUM | OSM_LSFT_ENT | SPC | SPC | ESC | U_NP | U_NP |
...
| LGUI     | LALT      | LCTL     | LSFT       |      |         | LSFT       | LCTL        | LALT      | LGUI     |
| U_BUTTON | ALGR      | LOCK_OPP | LOCK_CUR   |      |         | LOCK_CUR   | LOCK_OPP    |           | U_BUTTON |
| U_NP     | U_NP      | U_FUN    |            | U_NA | U_MOUSE | U_NAV      | U_MEDIA     | U_NP      | U_NP     |
...
| Q     | DF(U_TAP) | DF(U_EXTRA) | DF(U_BASE) | Z     | [ | 7 | 8 | 9 | ] |
| LGUI  | LALT      | LCTL        | LSFT       | SCLN  | = | 1 | 2 | 3 | 0 |
...
| DF(U_NAV)    | TD(U_TD_U_NAV)   | &u_to_U_NAV   | U_DF(U_NAV)   |
| DF(U_NUM)    | TD(U_TD_U_NUM)   | &u_to_U_NUM   | U_DF(U_NUM)   |
| DLR          | DLR              | DLLR          | $             |
| DOT          | DOT              | DOT           | .             |
| DOWN         | DOWN             | DOWN          | down          |
...
| OSM_LSFT_ENT | TD(OSM_LSFT_ENT) | &skq LSHFT    |               |
