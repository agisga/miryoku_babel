...
&kp Q,             &kp Z,             &kp QU,            &u_to_U_BASE,      &kp COLON,         &kp LBKT,          &kp NUM_7,         &kp NUM_8,         &kp NUM_9,         &kp RBKT,          \
...
&kp COLONQ,        &kp COLONWQ,       U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              &kp LATEX_PAREN,   &kp LATEX_SQBRA,   &kp LATEX_CURLYBRA,\
